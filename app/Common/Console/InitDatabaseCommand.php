...
class InitDatabaseCommand extends Command
{
    ...
    /** @var string[] list of files to be processed*/
    private array $files = [];

    /** name of file that is being processed */
    private string $currentFile;
    /** @var string[] - sql queries of current file  */
    private array $currentQueries;
    /** index of currently processed query */
    private int $currentQueryIndex;

    /** printing parameter */
    private int $maxLengthProgress;
    ...
    private function executeCurrentFile(OutputInterface $output)
    {
        ...
        $this->currentQueries = array_filter(explode(';', $script), fn ($query) => !empty(trim($query)));
